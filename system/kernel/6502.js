/***********************************************************
 * 6502 CPU VSS - 1.1                                      *
 * Copyright 2016/2017 (C) Ballagyr                        *
 * http://www.6502.eu.org/                                 *
 *                                                         *
 * Based on 6502asm by Stian Soreng (C) 2006-2010          *
 *                                                         *
 ***********************************************************/
...
function hexdump() {
  w = window.open('', 'hexdump', 'width=500, height=300, menubar=no, resizable=yes, scrollbars=yes, status=no, titlebar=no, toolbar=no' );

  html = "<!DOCTYPE html PUBLIC '-//W3C//DTD HTML 3.2 Final//EN'>\n<html>\n<head>";
  html += "<title>Hexdump</title>\n</head>\n<body>";
  html += "<code>";
  for( x=0; x<codeLen; x++ ) {
    if( (x&15) == 0 ) {
      html += "<br/> ";
